    ...
    while True:
        ...
        while True and select == 1:
            ...
            try:
                ...
                opening_deposit = int(input('Enter the amount you want to deposit\n'))
            except TypeError:
                ...
                if option == 2:
                    if custm:
                        ...
                        print('Entered Credentials did not match, Please try it again')
                else:
                    if exist_custm == 2:
                        ...
                        print('Entered Credentials didnot match, Please try it again')
                        continue
                    if acc_type.upper() == 'C':
